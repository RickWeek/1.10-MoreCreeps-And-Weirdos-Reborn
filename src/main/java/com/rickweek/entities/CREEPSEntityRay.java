...
public class CREEPSEntityRay extends Entity
{
    protected int hitX;
    protected int hitY;
    protected int hitZ;
    ...
    public void onUpdate()
    {
        ...
        if (movingobjectposition != null)
        {
            if (movingobjectposition.entityHit != null)
            {
                ...
                if ((movingobjectposition.entityHit instanceof EntityLiving) && playerFire || playerFire)
                {
            ...
            worldObj.playSound((EntityPlayer) null, getPosition(), MCSoundEvents.ITEM_RAYGUN, SoundCategory.NEUTRAL,  0.2F, 1.0F / (rand.nextFloat() * 0.1F + 0.95F));
            setDead();
        }
