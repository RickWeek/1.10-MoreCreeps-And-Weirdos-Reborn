...
public class CREEPSEntityPrisoner extends EntityMob
{
    ...
    {
        "mcw:textures/entity/prisoner1.png", "mcw:textures/entity/prisoner2.png", "mcw:textures/entity/prisoner3.png", "mcw:textures/entity/prisoner4.png", "mcw:textures/entity/prisoner5.png"
    };
    ...
    public void giveReward(EntityPlayer player)
    {
        ...
        if (rand.nextInt(4) == 0)
        {
            ...
            worldObj.playSound((EntityPlayer) null, getPosition(), MCSoundEvents.ENTITY_PRISONER_SORRY, SoundCategory.NEUTRAL, 1.0F, 1.0F);
            return;
        }

        // worldObj.playSoundAtEntity(this, "morecreeps:prisonerreward", 1.0F, 1.0F);
        worldObj.playSound((EntityPlayer) null, getPosition(), MCSoundEvents.ENTITY_PRISONER_REWARD, SoundCategory.NEUTRAL, 1.0F, 1.0F);
        saved = true;
        ...
        if (player != null)
        {
            ...
            switch (i)
            {
                ...
                case 4:
                    entityitem = entityDropItem(new ItemStack(MCItems.Money, rand.nextInt(20) + 1, 0), 1.0F);
                    break;

                default:
                    entityitem = entityDropItem(new ItemStack(MCItems.Money, rand.nextInt(5) + 1, 0), 1.0F);
                    break;
            }
    ...
    protected SoundEvent getAmbientSound()
    {
        if (rand.nextInt(5) == 0)
        {
            return MCSoundEvents.ENTITY_PRISONER;
        }
        else
        {
            return null;
    ...
    {
        return MCSoundEvents.ENTITY_PRISONER_HURT;
    }
    ...
    {
        return MCSoundEvents.ENTITY_PRISONER_DEATH;
    }
