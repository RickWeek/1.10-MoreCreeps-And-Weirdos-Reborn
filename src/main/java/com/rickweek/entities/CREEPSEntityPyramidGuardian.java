...
public class CREEPSEntityPyramidGuardian extends EntityMob
{
    ...
    {
        super(world);
        texture = "mcw:textures/entity/pyramidguardian.png";
        found = false;
        rotationYaw = 0.0F;
        setSize(0.4F, 0.4F);
        alternate = 1;
    ...
    {
        worldObj.playSound((EntityPlayer) null, getPosition(), MCSoundEvents.ENTITY_PYRAMIDGUARDIAN_CURSE, SoundCategory.NEUTRAL, 1.0F, (rand.nextFloat() - rand.nextFloat()) * 0.2F + 1.0F);
    ...
    {
        return MCSoundEvents.ENTITY_PYRAMIDGUARDIAN;
    }
    ...
    {
        return MCSoundEvents.ENTITY_PYRAMIDGUARDIAN_HURT;
    }
    ...
    {
        return MCSoundEvents.ENTITY_PYRAMIDGUARDIAN_DEATH;
    }
