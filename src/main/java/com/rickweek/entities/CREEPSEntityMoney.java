...
public class CREEPSEntityMoney extends EntityThrowable
{
    ...
    public void onCollideWithPlayer(EntityPlayer entityplayer)
    {
        ...
        {
            if (entityplayer.inventory.addItemStackToInventory(new ItemStack(MCItems.Money, 1, 0)))
            {
                // worldObj.playSoundAtEntity(this, "random.pop", 0.2F, ((rand.nextFloat() - rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
                worldObj.playSound((EntityPlayer) null, getPosition(), SoundEvents.ENTITY_ARROW_SHOOT, SoundCategory.NEUTRAL, 0.2F, ((rand.nextFloat() - rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
    ...
    {
    	return new ItemStack(MCItems.Money, 1, 0);
    }
