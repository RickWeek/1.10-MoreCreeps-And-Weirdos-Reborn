...
public class CREEPSEntityManDog extends EntityMob
{
    ...
    {
        super(world);
        texture = "mcw:textures/entity/mandog.png";
        hasAttacked = false;
        foundplayer = false;
        frisbeetime = 0;
        chase = false;
    ...
    public void applyEntityAttributes()
    {
    	...
    	this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.666D);
    ...
    public void onUpdate()
    {
        ...
        if (tamed)
        {
            ...
            if (chase)
            {
                ...
                {
                    worldObj.playSound((EntityPlayer) null, getPosition(), SoundEvents.ENTITY_EGG_THROW, SoundCategory.NEUTRAL, 0.2F, ((rand.nextFloat() - rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
                    frisbeestack = new ItemStack(MCItems.Frisbee, 1, 0);
                    frisbeeent.setDead();
                    chase = false;
                    fetch = true;
                    frisbeehold = true;
    ...
    public boolean interact(EntityPlayer entityplayer)
    {
        ...
        if (itemstack != null)
        {
            if (itemstack.getItem() == Items.COOKED_PORKCHOP)
            {
                ...
                {
                    smoke();
                    // TODO worldObj.playSoundAtEntity(this, "morecreeps:mandogtamed", 1.0F, (rand.nextFloat() - rand.nextFloat()) * 0.2F + 1.0F);
                    
                    tamed = true;
                    this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(45D);
                    texture = "mcw:textures/entity/mandogtamed.png";
                }
            }
    ...
    protected SoundEvent getAmbientSound()
    {
        if (superdog)
        {
            // TODO return "morecreeps:superdogname";
            return null;
        }
        else
        {
            // TODO return "morecreeps:mandog";
            return null;
        }
    }
    ...
    {
        // TODO return "morecreeps:mandoghurt";
        return null;
    }
    ...
    {
        // TODO return "morecreeps:mandogdeath";
        return null;
    }
