...
public class CREEPSEntityEvilCreature extends EntityMob
{
    ...
    {
        super(world);
        texture = "mcw:textures/entity/evilcreature.png";
    ...
    public void applyEntityAttributes()
    {
    	...
    	this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(110D);
    	this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.2300004D);
    ...
    protected void attackEntity(Entity entity, float f)
    {
        if (onGround && jumping)
        {
            ...
            worldObj.playSound((EntityPlayer) null, getPosition(), MCSoundEvents.ENTITY_EVILCREATURE_JUMP, SoundCategory.NEUTRAL, 1.0F * (modelsize / 3F), (rand.nextFloat() - rand.nextFloat()) * 0.2F + 1.0F + (3F - modelsize) * 2.0F);
    ...
    {
        return MCSoundEvents.ENTITY_EVILCREATURE;
    }
    ...
    {
        return MCSoundEvents.ENTITY_EVILCREATURE_HURT;
    }
    ...
    {
        return MCSoundEvents.ENTITY_EVILCREATURE_DEATH;
    }
