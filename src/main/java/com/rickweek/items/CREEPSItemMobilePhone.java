...
public class CREEPSItemMobilePhone extends Item {
		public CREEPSItemMobilePhone(String unlocalizedName, String registryName) {
    ...
    public ActionResult<ItemStack> onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer, EnumHand hand)
    {
        ...
        world.playSound((EntityPlayer) null, entityplayer.getPosition(), MCSoundEvents.ITEM_MOBILE, SoundCategory.PLAYERS, 1.0F, (itemRand.nextFloat() - itemRand.nextFloat()) * 0.2F + 1.0F);
