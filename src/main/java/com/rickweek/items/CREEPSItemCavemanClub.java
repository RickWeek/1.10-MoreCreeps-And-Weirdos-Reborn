...
public class CREEPSItemCavemanClub extends ItemSword
{
    ...
    public CREEPSItemCavemanClub(String unlocalizedName, String registryName)
    {
    ...
    public void onUpdate(ItemStack itemstack, World world, Entity entity, int i, boolean flag)
    {
        ...
        if (flag && drumsound-- < 0)
        {
            ...
            world.playSound((EntityPlayer) null, entity.getPosition(), MCSoundEvents.ITEM_CAVEDRUMS, SoundCategory.PLAYERS, 1.0F, 1.0F);
        }
    }
}