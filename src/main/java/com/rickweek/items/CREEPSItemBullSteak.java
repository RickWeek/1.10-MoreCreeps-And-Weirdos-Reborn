...
public class CREEPSItemBullSteak extends ItemFood {

	private PotionEffect[] effects;
	
	public CREEPSItemBullSteak(String unlocalizedName, int amount, boolean isWolfFood) {
		super(amount, isWolfFood);
		this.setUnlocalizedName(unlocalizedName);
		this.setRegistryName(new ResourceLocation(Reference.MODID, unlocalizedName));
	}
	
	public CREEPSItemBullSteak(String unlocalizedName, int amount, float saturation, boolean isWolfFood) {
