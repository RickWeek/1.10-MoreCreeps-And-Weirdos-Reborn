    ...
    public boolean generate(World world, Random random, int i, int j, int k)
    {
        ...
        if (sandy && chunky && l < maxObstruct)
        {
            ...
            for (int j8 = 1; j8 < tileentitychest.getSizeInventory(); j8++)
            {
                ...
                if (k8 == 0)
                {
                    tileentitychest.setInventorySlotContents(j8, new ItemStack(MCItems.Bandaid, rand.nextInt(15) + 1, 0));
                }
                ...
                if (k8 == 2)
                {
                    tileentitychest.setInventorySlotContents(j8, new ItemStack(MCItems.Money, 1, 0));
                }

                if (k8 == 3)
                {
                    tileentitychest.setInventorySlotContents(j8, new ItemStack(MCItems.Money, rand.nextInt(15) + 1, 0));
                }

                if (k8 == 4)
                {
                    tileentitychest.setInventorySlotContents(j8, new ItemStack(MCItems.Blorpcola, rand.nextInt(10) + 5, 0));
                }
                ...
                if (k8 == 12)
                {
                    tileentitychest.setInventorySlotContents(j8, new ItemStack(MCItems.EvilEgg, rand.nextInt(15) + 1, 0));
                }
                ...
                if (k8 == 26)
                {
                    tileentitychest.setInventorySlotContents(j8, new ItemStack(MCItems.EvilEgg, rand.nextInt(40) + 1, 0));
                }
