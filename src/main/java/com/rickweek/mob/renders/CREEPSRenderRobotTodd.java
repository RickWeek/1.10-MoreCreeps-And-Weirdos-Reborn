...
import com.rickweek.mob.renders.layers.LayerRobotTodd;
...
public class CREEPSRenderRobotTodd extends RenderLiving
{
    ...
    public CREEPSRenderRobotTodd(RenderManager renderManager, CREEPSModelRobotTodd creepsmodelrobottodd, float f)
    {
