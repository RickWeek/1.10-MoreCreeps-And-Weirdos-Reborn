...
import com.rickweek.mob.renders.layers.LayerRobotTed;
...
public class CREEPSRenderRobotTed extends RenderLiving
{
    ...
    public CREEPSRenderRobotTed(RenderManager renderManager, CREEPSModelRobotTed creepsmodelrobotted, float f)
    {
